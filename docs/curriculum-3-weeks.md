...
이 일정은 제안 학습 루트입니다. 실제 개발 작업 순서와 주차별 산출물은 [`3주 개발 진행 방식`](3-week-development-workflow.md)을 함께 참고하세요. 목업 지갑을 안전한 기본값으로 유지하고, 미래 작업에서 명확히 승인되기 전까지 실제 지갑 의존성은 추가하지 않습니다.
